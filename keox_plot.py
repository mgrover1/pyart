...
fig.suptitle("#1488 case: fixed vad_michelson tracks NEXRAD Level 3", x=0.03, ha="left",
...
fig.text(0.03, 0.915,
         ...
         "Fixed Michelson rejects unreliable fits and weights the rest; no height spikes.",
